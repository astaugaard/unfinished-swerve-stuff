...
class RobotContainer {
    ...
    private val pigeon = Pigeon2(0);
    private val swerveDrive = SwerveDrive(pigeon);
    ...
    init {
        ...
        configureBindings()
        swerveDrive.setvx(0.0);
        swerveDrive.setvy(0.0);
        swerveDrive.setRotationSpeed(0.0);
    }
    ...
    val teleopCommand: Command
        get() {
            return DriveCommand(swerveDrive);
        }
